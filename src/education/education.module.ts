...
import { UpdateEducationService } from './application/services/update-education.service';
import { DeleteEducationService } from './application/services/delete-education.service';
    ...
    return {
      ...
      providers: [
        ...
        },
        {
          ...
          useClass: UpdateEducationService,
        },
        {
          provide: DeleteEducationUseCase,
          useClass: DeleteEducationService,
        },
        {
