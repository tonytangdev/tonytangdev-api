...
export class ExperienceResponseDto {
  ...
  @ApiPropertyOptional({ description: 'End date', example: '2023-12-31', nullable: true })
  endDate: string | null;

  @ApiProperty({ description: 'Job description' })
  description: string;

  @ApiProperty({ description: 'Technologies used', type: [String], example: ['TypeScript', 'React'] })
  technologies: string[];
